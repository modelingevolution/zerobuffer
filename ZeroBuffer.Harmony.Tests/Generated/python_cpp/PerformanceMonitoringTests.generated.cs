...
public class PerformanceMonitoringTests : HarmonyTestBase
{
    ...
    {
        DeserializeScenarioStatic(Test_9_1_CPU_Usage_Monitoring_reader_python_writer_cpp_Json)
    };
    #endregion

    #region Test Methods
    [Fact(DisplayName = "Test 9.1 - CPU Usage Monitoring [reader=python, writer=cpp]")]
    [Trait("Scenario", "Test 9.1 - CPU Usage Monitoring")]
    [Trait("Platform", "python/cpp")]
    [Trait("Uses", "cpp")]
    [Trait("Uses", "python")]
    [Trait("Feature", "09-PerformanceMonitoring")]    public async Task Test_9_1_CPU_Usage_Monitoring_reader_python_writer_cpp()
    {
        var scenario = DeserializeScenario(Test_9_1_CPU_Usage_Monitoring_reader_python_writer_cpp_Json);
