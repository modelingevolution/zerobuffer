...
public class PerformanceMonitoringTests : HarmonyTestBase
{
    ...
    {
        DeserializeScenarioStatic(Test_9_1_CPU_Usage_Monitoring_reader_csharp_writer_csharp_Json)
    };
    #endregion

    #region Test Methods
    [Fact(DisplayName = "Test 9.1 - CPU Usage Monitoring [reader=csharp, writer=csharp]")]
    [Trait("Scenario", "Test 9.1 - CPU Usage Monitoring")]
    [Trait("Platform", "csharp/csharp")]
    [Trait("Uses", "csharp")]
    [Trait("Feature", "09-PerformanceMonitoring")]    public async Task Test_9_1_CPU_Usage_Monitoring_reader_csharp_writer_csharp()
    {
        var scenario = DeserializeScenario(Test_9_1_CPU_Usage_Monitoring_reader_csharp_writer_csharp_Json);
