...
public class ProtocolComplianceTests : HarmonyTestBase
{
    ...
    {
        DeserializeScenarioStatic(Test_12_1_Protocol_Compliance_OIEB_reader_csharp_writer_csharp_Json),
        DeserializeScenarioStatic(Test_12_2_Memory_Alignment_Verification_reader_csharp_writer_csharp_Json)
    };
    #endregion

    #region Test Methods
    [Fact(DisplayName = "Test 12.1 - Protocol Compliance OIEB [reader=csharp, writer=csharp]")]
    [Trait("Scenario", "Test 12.1 - Protocol Compliance OIEB")]
    [Trait("Platform", "csharp/csharp")]
    [Trait("Uses", "csharp")]
    [Trait("Feature", "12-ProtocolCompliance")]    public async Task Test_12_1_Protocol_Compliance_OIEB_reader_csharp_writer_csharp()
    {
        var scenario = DeserializeScenario(Test_12_1_Protocol_Compliance_OIEB_reader_csharp_writer_csharp_Json);
        await ExecuteScenarioAsync(scenario);
    }

    [Fact(DisplayName = "Test 12.2 - Memory Alignment Verification [reader=csharp, writer=csharp]")]
    [Trait("Scenario", "Test 12.2 - Memory Alignment Verification")]
    [Trait("Platform", "csharp/csharp")]
    [Trait("Uses", "csharp")]
    [Trait("Feature", "12-ProtocolCompliance")]    public async Task Test_12_2_Memory_Alignment_Verification_reader_csharp_writer_csharp()
    {
        var scenario = DeserializeScenario(Test_12_2_Memory_Alignment_Verification_reader_csharp_writer_csharp_Json);
        await ExecuteScenarioAsync(scenario);
    }
