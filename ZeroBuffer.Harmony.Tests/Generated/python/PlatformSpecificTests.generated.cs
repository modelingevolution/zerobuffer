...
public class PlatformSpecificTests : HarmonyTestBase
{
    ...
    public static IEnumerable<ScenarioExecution> Scenarios => new[]
    {
        ...
        DeserializeScenarioStatic(Test_13_3_Lock_File_Semantics_reader_python_Json)
    };
    #endregion
    ...
    {
        var scenario = DeserializeScenario(Test_13_3_Lock_File_Semantics_reader_python_Json);
        await ExecuteScenarioAsync(scenario);
    }
