...
public class SystemResourcesTests : HarmonyTestBase
{
    ...
    [Trait("Uses", "python")]
    [Trait("Feature", "07-SystemResources")]    public async Task Test_7_3_Memory_Barrier_Verification_reader_python_writer_python()
    {
    ...
    [Trait("Platform", "python/python")]
    [Trait("Uses", "python")]
    [Trait("Feature", "07-SystemResources")]    public async Task Test_7_4_Pattern_Validation_reader_python_writer_python()
    {
