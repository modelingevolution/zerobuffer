...
public class DuplexChannelTests : HarmonyTestBase
{
    ...
    {
        DeserializeScenarioStatic(Test_14_1_Basic_Request_Response_client_python_server_python_Json),
        DeserializeScenarioStatic(Test_14_2_Sequence_Number_Correlation_client_python_server_python_Json),
        DeserializeScenarioStatic(Test_14_3_Concurrent_Client_Operations_client_python_server_python_Json),
        DeserializeScenarioStatic(Test_14_4_Server_Processing_Mode_SingleThread_client_python_server_python_Json),
        DeserializeScenarioStatic(Test_14_5_Server_Death_During_Processing_client_python_server_python_Json),
        DeserializeScenarioStatic(Test_14_6_Buffer_Full_on_Response_Channel_client_python_server_python_Json),
        DeserializeScenarioStatic(Test_14_7_Zero_Copy_Client_Operations_client_python_server_python_Json)
    };
    #endregion

    #region Test Methods
    [Fact(DisplayName = "Test 14.1 - Basic Request-Response [client=python, server=python]")]
    [Trait("Scenario", "Test 14.1 - Basic Request-Response")]
    [Trait("Platform", "python/python")]
    [Trait("Uses", "python")]
    [Trait("Feature", "DuplexChannel")]    public async Task Test_14_1_Basic_Request_Response_client_python_server_python()
    {
        var scenario = DeserializeScenario(Test_14_1_Basic_Request_Response_client_python_server_python_Json);
        await ExecuteScenarioAsync(scenario);
    }

    [Fact(DisplayName = "Test 14.2 - Sequence Number Correlation [client=python, server=python]")]
    [Trait("Scenario", "Test 14.2 - Sequence Number Correlation")]
    [Trait("Platform", "python/python")]
    [Trait("Uses", "python")]
    [Trait("Feature", "DuplexChannel")]    public async Task Test_14_2_Sequence_Number_Correlation_client_python_server_python()
    {
        var scenario = DeserializeScenario(Test_14_2_Sequence_Number_Correlation_client_python_server_python_Json);
        await ExecuteScenarioAsync(scenario);
    }

    [Fact(DisplayName = "Test 14.3 - Concurrent Client Operations [client=python, server=python]")]
    [Trait("Scenario", "Test 14.3 - Concurrent Client Operations")]
    [Trait("Platform", "python/python")]
    [Trait("Uses", "python")]
    [Trait("Feature", "DuplexChannel")]    public async Task Test_14_3_Concurrent_Client_Operations_client_python_server_python()
    {
        var scenario = DeserializeScenario(Test_14_3_Concurrent_Client_Operations_client_python_server_python_Json);
        await ExecuteScenarioAsync(scenario);
    }

    [Fact(DisplayName = "Test 14.4 - Server Processing Mode SingleThread [client=python, server=python]")]
    [Trait("Scenario", "Test 14.4 - Server Processing Mode SingleThread")]
    [Trait("Platform", "python/python")]
    [Trait("Uses", "python")]
    [Trait("Feature", "DuplexChannel")]    public async Task Test_14_4_Server_Processing_Mode_SingleThread_client_python_server_python()
    {
        var scenario = DeserializeScenario(Test_14_4_Server_Processing_Mode_SingleThread_client_python_server_python_Json);
        await ExecuteScenarioAsync(scenario);
    }

    [Fact(DisplayName = "Test 14.5 - Server Death During Processing [client=python, server=python]")]
    [Trait("Scenario", "Test 14.5 - Server Death During Processing")]
    [Trait("Platform", "python/python")]
    [Trait("Uses", "python")]
    [Trait("Feature", "DuplexChannel")]    public async Task Test_14_5_Server_Death_During_Processing_client_python_server_python()
    {
        var scenario = DeserializeScenario(Test_14_5_Server_Death_During_Processing_client_python_server_python_Json);
        await ExecuteScenarioAsync(scenario);
    }

    [Fact(DisplayName = "Test 14.6 - Buffer Full on Response Channel [client=python, server=python]")]
    [Trait("Scenario", "Test 14.6 - Buffer Full on Response Channel")]
    [Trait("Platform", "python/python")]
    [Trait("Uses", "python")]
    [Trait("Feature", "DuplexChannel")]    public async Task Test_14_6_Buffer_Full_on_Response_Channel_client_python_server_python()
    {
        var scenario = DeserializeScenario(Test_14_6_Buffer_Full_on_Response_Channel_client_python_server_python_Json);
        await ExecuteScenarioAsync(scenario);
    }

    [Fact(DisplayName = "Test 14.7 - Zero-Copy Client Operations [client=python, server=python]")]
    [Trait("Scenario", "Test 14.7 - Zero-Copy Client Operations")]
    [Trait("Platform", "python/python")]
    [Trait("Uses", "python")]
    [Trait("Feature", "DuplexChannel")]    public async Task Test_14_7_Zero_Copy_Client_Operations_client_python_server_python()
    {
        var scenario = DeserializeScenario(Test_14_7_Zero_Copy_Client_Operations_client_python_server_python_Json);
        await ExecuteScenarioAsync(scenario);
    }
