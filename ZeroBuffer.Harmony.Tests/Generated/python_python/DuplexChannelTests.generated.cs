...
public class DuplexChannelTests : HarmonyTestBase
{
    ...
    private static readonly string Test_13_8_Mutable_vs_Immutable_Server_client_python_server_python_Json = @"{""TestId"":""python-python-test-13-8---mutable-vs-immutable-server"",""FeatureId"":13,""ScenarioName"":""Test 13.8 - Mutable vs Immutable Server"",""ScenarioDescription"":null,""Tags"":[],""Platforms"":{""client"":""python"",""server"":""python""},""Background"":[],""Steps"":[{""Type"":""Given"",""Text"":""the \u0027server\u0027 process creates duplex channel \u0027duplex-mutable\u0027 with mutable handler"",""Process"":""server"",""ProcessedText"":""creates duplex channel \u0027duplex-mutable\u0027 with mutable handler"",""Parameters"":{}},{""Type"":""Given"",""Text"":""the \u0027server\u0027 process creates duplex channel \u0027duplex-immutable\u0027 with immutable handler"",""Process"":""server"",""ProcessedText"":""creates duplex channel \u0027duplex-immutable\u0027 with immutable handler"",""Parameters"":{}},{""Type"":""Given"",""Text"":""both handlers implement XOR with key \u00270xFF\u0027"",""Process"":""server"",""ProcessedText"":""both handlers implement XOR with key \u00270xFF\u0027"",""Parameters"":{}},{""Type"":""When"",""Text"":""the \u0027client\u0027 process creates duplex channel client \u0027duplex-mutable\u0027"",""Process"":""client"",""ProcessedText"":""creates duplex channel client \u0027duplex-mutable\u0027"",""Parameters"":{}},{""Type"":""When"",""Text"":""the \u0027client\u0027 process creates duplex channel client \u0027duplex-immutable\u0027"",""Process"":""client"",""ProcessedText"":""creates duplex channel client \u0027duplex-immutable\u0027"",""Parameters"":{}},{""Type"":""When"",""Text"":""the \u0027client\u0027 process sends identical \u002710240\u0027 byte frames to both"",""Process"":""client"",""ProcessedText"":""sends identical \u002710240\u0027 byte frames to both"",""Parameters"":{}},{""Type"":""Then"",""Text"":""both should produce identical XOR results"",""Process"":null,""ProcessedText"":""both should produce identical XOR results"",""Parameters"":{}},{""Type"":""Then"",""Text"":""the mutable server should modify in-place"",""Process"":""client"",""ProcessedText"":""the mutable server should modify in-place"",""Parameters"":{}},{""Type"":""Then"",""Text"":""the mutable server should have no allocations"",""Process"":""client"",""ProcessedText"":""the mutable server should have no allocations"",""Parameters"":{}},{""Type"":""Then"",""Text"":""the immutable server should return new data"",""Process"":""client"",""ProcessedText"":""the immutable server should return new data"",""Parameters"":{}}]}";
