...
public class ProtocolComplianceTests : HarmonyTestBase
{
    ...
    {
        DeserializeScenarioStatic(Test_12_1_Protocol_Compliance_OIEB_reader_python_writer_python_Json),
        DeserializeScenarioStatic(Test_12_2_Memory_Alignment_Verification_reader_python_writer_python_Json)
    };
    #endregion

    #region Test Methods
    [Fact(DisplayName = "Test 12.1 - Protocol Compliance OIEB [reader=python, writer=python]")]
    [Trait("Scenario", "Test 12.1 - Protocol Compliance OIEB")]
    [Trait("Platform", "python/python")]
    [Trait("Uses", "python")]
    [Trait("Feature", "12-ProtocolCompliance")]    public async Task Test_12_1_Protocol_Compliance_OIEB_reader_python_writer_python()
    {
        var scenario = DeserializeScenario(Test_12_1_Protocol_Compliance_OIEB_reader_python_writer_python_Json);
        await ExecuteScenarioAsync(scenario);
    }

    [Fact(DisplayName = "Test 12.2 - Memory Alignment Verification [reader=python, writer=python]")]
    [Trait("Scenario", "Test 12.2 - Memory Alignment Verification")]
    [Trait("Platform", "python/python")]
    [Trait("Uses", "python")]
    [Trait("Feature", "12-ProtocolCompliance")]    public async Task Test_12_2_Memory_Alignment_Verification_reader_python_writer_python()
    {
        var scenario = DeserializeScenario(Test_12_2_Memory_Alignment_Verification_reader_python_writer_python_Json);
        await ExecuteScenarioAsync(scenario);
    }
