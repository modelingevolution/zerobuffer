...
public class DuplexChannelTests : HarmonyTestBase
{
    ...
    public static IEnumerable<ScenarioExecution> Scenarios => new[]
    {
        ...
        DeserializeScenarioStatic(Test_13_2_Request_Response_Order_Preservation_client_csharp_server_cpp_Json),
        ...
        DeserializeScenarioStatic(Test_13_8_Immutable_Server_Handler_Types_client_csharp_server_cpp_Json),
    ...
    [Fact(DisplayName = "Test 13.2 - Request-Response Order Preservation [client=csharp, server=cpp]")]
    [Trait("Scenario", "Test 13.2 - Request-Response Order Preservation")]
    [Trait("Platform", "csharp/cpp")]
    [Trait("Uses", "cpp")]
    [Trait("Uses", "csharp")]
    [Trait("Feature", "13-DuplexChannel")]    public async Task Test_13_2_Request_Response_Order_Preservation_client_csharp_server_cpp()
    {
        var scenario = DeserializeScenario(Test_13_2_Request_Response_Order_Preservation_client_csharp_server_cpp_Json);
        await ExecuteScenarioAsync(scenario);
    }
    ...
    [Fact(DisplayName = "Test 13.8 - Immutable Server Handler Types [client=csharp, server=cpp]")]
    [Trait("Scenario", "Test 13.8 - Immutable Server Handler Types")]
    [Trait("Platform", "csharp/cpp")]
    [Trait("Uses", "cpp")]
    [Trait("Uses", "csharp")]
    [Trait("Feature", "13-DuplexChannel")]    public async Task Test_13_8_Immutable_Server_Handler_Types_client_csharp_server_cpp()
    {
        var scenario = DeserializeScenario(Test_13_8_Immutable_Server_Handler_Types_client_csharp_server_cpp_Json);
        await ExecuteScenarioAsync(scenario);
    }
