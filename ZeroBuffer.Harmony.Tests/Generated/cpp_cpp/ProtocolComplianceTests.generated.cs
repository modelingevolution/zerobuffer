...
public class ProtocolComplianceTests : HarmonyTestBase
{
    ...
    {
        DeserializeScenarioStatic(Test_12_1_Protocol_Compliance_OIEB_reader_cpp_writer_cpp_Json),
        DeserializeScenarioStatic(Test_12_2_Memory_Alignment_Verification_reader_cpp_writer_cpp_Json)
    };
    #endregion

    #region Test Methods
    [Fact(DisplayName = "Test 12.1 - Protocol Compliance OIEB [reader=cpp, writer=cpp]")]
    [Trait("Scenario", "Test 12.1 - Protocol Compliance OIEB")]
    [Trait("Platform", "cpp/cpp")]
    [Trait("Uses", "cpp")]
    [Trait("Feature", "12-ProtocolCompliance")]    public async Task Test_12_1_Protocol_Compliance_OIEB_reader_cpp_writer_cpp()
    {
        var scenario = DeserializeScenario(Test_12_1_Protocol_Compliance_OIEB_reader_cpp_writer_cpp_Json);
        await ExecuteScenarioAsync(scenario);
    }

    [Fact(DisplayName = "Test 12.2 - Memory Alignment Verification [reader=cpp, writer=cpp]")]
    [Trait("Scenario", "Test 12.2 - Memory Alignment Verification")]
    [Trait("Platform", "cpp/cpp")]
    [Trait("Uses", "cpp")]
    [Trait("Feature", "12-ProtocolCompliance")]    public async Task Test_12_2_Memory_Alignment_Verification_reader_cpp_writer_cpp()
    {
        var scenario = DeserializeScenario(Test_12_2_Memory_Alignment_Verification_reader_cpp_writer_cpp_Json);
        await ExecuteScenarioAsync(scenario);
    }
