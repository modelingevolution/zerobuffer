...
public class DuplexChannelTests : HarmonyTestBase
{
    ...
    public static IEnumerable<ScenarioExecution> Scenarios => new[]
    {
        ...
        DeserializeScenarioStatic(Test_13_2_Request_Response_Order_Preservation_client_cpp_server_cpp_Json),
        ...
        DeserializeScenarioStatic(Test_13_8_Immutable_Server_Handler_Types_client_cpp_server_cpp_Json),
    ...
    [Fact(DisplayName = "Test 13.2 - Request-Response Order Preservation [client=cpp, server=cpp]")]
    [Trait("Scenario", "Test 13.2 - Request-Response Order Preservation")]
    [Trait("Platform", "cpp/cpp")]
    [Trait("Uses", "cpp")]
    [Trait("Feature", "13-DuplexChannel")]    public async Task Test_13_2_Request_Response_Order_Preservation_client_cpp_server_cpp()
    {
        var scenario = DeserializeScenario(Test_13_2_Request_Response_Order_Preservation_client_cpp_server_cpp_Json);
        await ExecuteScenarioAsync(scenario);
    }
    ...
    [Fact(DisplayName = "Test 13.8 - Immutable Server Handler Types [client=cpp, server=cpp]")]
    [Trait("Scenario", "Test 13.8 - Immutable Server Handler Types")]
    [Trait("Platform", "cpp/cpp")]
    [Trait("Uses", "cpp")]
    [Trait("Feature", "13-DuplexChannel")]    public async Task Test_13_8_Immutable_Server_Handler_Types_client_cpp_server_cpp()
    {
        var scenario = DeserializeScenario(Test_13_8_Immutable_Server_Handler_Types_client_cpp_server_cpp_Json);
        await ExecuteScenarioAsync(scenario);
    }
