...
public class InitializationTests : HarmonyTestBase
{
    ...
    {
        const string scenarioJson = @"{""TestId"":""csharp-test-3-2---concurrent-initialization-race"",""ScenarioName"":""Test 3.2 - Concurrent Initialization Race"",""ScenarioDescription"":null,""Tags"":[],""Platforms"":{""reader"":""csharp""},""Background"":[{""Type"":""Given"",""Text"":""the test mode is configured"",""Process"":null,""ProcessedText"":""the test mode is configured"",""Parameters"":{}}],""Steps"":[{""Type"":""Given"",""Text"":""two readers \u0027csharp\u0027 and \u0027python\u0027"",""Process"":""reader"",""ProcessedText"":"""",""Parameters"":{}},{""Type"":""When"",""Text"":""both simultaneously attempt to create buffer \u0027race-test\u0027"",""Process"":null,""ProcessedText"":""both simultaneously attempt to create buffer \u0027race-test\u0027"",""Parameters"":{}},{""Type"":""Then"",""Text"":""only one should succeed"",""Process"":null,""ProcessedText"":""only one should succeed"",""Parameters"":{}},{""Type"":""And"",""Text"":""other should receive appropriate error"",""Process"":""reader"",""ProcessedText"":""other should receive appropriate error"",""Parameters"":{}},{""Type"":""And"",""Text"":""no resource corruption should occur"",""Process"":""reader"",""ProcessedText"":""no resource corruption should occur"",""Parameters"":{}}]}";
