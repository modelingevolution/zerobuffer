...
public class DuplexChannelTests : HarmonyTestBase
{
    ...
    public static IEnumerable<ScenarioExecution> Scenarios => new[]
    {
        ...
        DeserializeScenarioStatic(Test_13_2_Request_Response_Order_Preservation_client_python_server_csharp_Json),
        ...
        DeserializeScenarioStatic(Test_13_8_Immutable_Server_Handler_Types_client_python_server_csharp_Json),
    ...
    [Fact(DisplayName = "Test 13.2 - Request-Response Order Preservation [client=python, server=csharp]")]
    [Trait("Scenario", "Test 13.2 - Request-Response Order Preservation")]
    [Trait("Platform", "python/csharp")]
    [Trait("Uses", "csharp")]
    [Trait("Uses", "python")]
    [Trait("Feature", "13-DuplexChannel")]    public async Task Test_13_2_Request_Response_Order_Preservation_client_python_server_csharp()
    {
        var scenario = DeserializeScenario(Test_13_2_Request_Response_Order_Preservation_client_python_server_csharp_Json);
        await ExecuteScenarioAsync(scenario);
    }
    ...
    [Fact(DisplayName = "Test 13.8 - Immutable Server Handler Types [client=python, server=csharp]")]
    [Trait("Scenario", "Test 13.8 - Immutable Server Handler Types")]
    [Trait("Platform", "python/csharp")]
    [Trait("Uses", "csharp")]
    [Trait("Uses", "python")]
    [Trait("Feature", "13-DuplexChannel")]    public async Task Test_13_8_Immutable_Server_Handler_Types_client_python_server_csharp()
    {
        var scenario = DeserializeScenario(Test_13_8_Immutable_Server_Handler_Types_client_python_server_csharp_Json);
        await ExecuteScenarioAsync(scenario);
    }
