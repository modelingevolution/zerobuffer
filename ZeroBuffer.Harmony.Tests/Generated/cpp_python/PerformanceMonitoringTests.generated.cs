...
public class PerformanceMonitoringTests : HarmonyTestBase
{
    ...
    {
        DeserializeScenarioStatic(Test_9_1_CPU_Usage_Monitoring_reader_cpp_writer_python_Json)
    };
    #endregion

    #region Test Methods
    [Fact(DisplayName = "Test 9.1 - CPU Usage Monitoring [reader=cpp, writer=python]")]
    [Trait("Scenario", "Test 9.1 - CPU Usage Monitoring")]
    [Trait("Platform", "cpp/python")]
    [Trait("Uses", "cpp")]
    [Trait("Uses", "python")]
    [Trait("Feature", "09-PerformanceMonitoring")]    public async Task Test_9_1_CPU_Usage_Monitoring_reader_cpp_writer_python()
    {
        var scenario = DeserializeScenario(Test_9_1_CPU_Usage_Monitoring_reader_cpp_writer_python_Json);
