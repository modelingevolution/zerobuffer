...
public class DuplexChannelTests : HarmonyTestBase
{
    ...
    public static IEnumerable<ScenarioExecution> Scenarios => new[]
    {
        ...
        DeserializeScenarioStatic(Test_13_2_Sequence_Number_Correlation_client_cpp_server_csharp_Json),
        ...
        DeserializeScenarioStatic(Test_13_8_Mutable_vs_Immutable_Server_client_cpp_server_csharp_Json),
    ...
    [Fact(DisplayName = "Test 13.2 - Sequence Number Correlation [client=cpp, server=csharp]")]
    [Trait("Scenario", "Test 13.2 - Sequence Number Correlation")]
    [Trait("Platform", "cpp/csharp")]
    [Trait("Uses", "cpp")]
    [Trait("Uses", "csharp")]
    [Trait("Feature", "13-DuplexChannel")]    public async Task Test_13_2_Sequence_Number_Correlation_client_cpp_server_csharp()
    {
        var scenario = DeserializeScenario(Test_13_2_Sequence_Number_Correlation_client_cpp_server_csharp_Json);
        await ExecuteScenarioAsync(scenario);
    }
    ...
    [Fact(DisplayName = "Test 13.8 - Mutable vs Immutable Server [client=cpp, server=csharp]")]
    [Trait("Scenario", "Test 13.8 - Mutable vs Immutable Server")]
    [Trait("Platform", "cpp/csharp")]
    [Trait("Uses", "cpp")]
    [Trait("Uses", "csharp")]
    [Trait("Feature", "13-DuplexChannel")]    public async Task Test_13_8_Mutable_vs_Immutable_Server_client_cpp_server_csharp()
    {
        var scenario = DeserializeScenario(Test_13_8_Mutable_vs_Immutable_Server_client_cpp_server_csharp_Json);
        await ExecuteScenarioAsync(scenario);
    }
